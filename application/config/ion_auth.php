...
//$config['tables']['tb_groups'] = 'jabatan';
//$config['tables']['users_groups'] = 'jabatanuser';
$config['tables']['tb_login_attempts'] = 'login_attempts';
 ...
 */
$config['join']['users'] = 'idusers';
//$config['join']['tb_groups'] = 'idjabatan';
 ...
 */
$config['site_title'] = "PERAMALAN";       // Site Title, example.com
$config['admin_email'] = "admin@admin.id"; // Admin Email, admin@example.com
